...
extern pjsua_transport_id pid;
int my_atoi(const char *cs);
//pj_status_t playwavfile(char *str, pj_caching_pool cp, pjmedia_endpt *med_endpt,pj_pool_t *pool,pjmedia_port *file_port,pjmedia_snd_port *snd_port);
//pj_status_t stopwavfile(pj_caching_pool cp, pjmedia_endpt *med_endpt,pj_pool_t *pool,pjmedia_port *file_port,pjmedia_snd_port *snd_port);
